...
public class workpolicyObj {
        ...
        @FindBy(xpath = "(//div[@class='ant-picker-cell-inner'])[20]")
        ...
        @FindBy(xpath = "//p[text()='In out Policy']")
        public static WebElement IOPolicyName;

        @FindBy(xpath = "//p[text()='Overtime Policy']")
        public static WebElement OverTimepolicyName;

        @FindBy(xpath = "//p[text()='Attendance on Offdays']")
        public static WebElement AOFPolicyName;

        @FindBy(xpath = "//p[text()='Miss punch Policy']")
        public static WebElement MissPolicyName;

        @FindBy(xpath = "(//span[@class='text-xl pr-1 font-semibold'])[1]")
        public static WebElement TimeInOutCount;

        @FindBy(xpath = "(//span[@class='text-xl pr-1 font-semibold'])[2]")
        public static WebElement OvertimeCount;

        @FindBy(xpath = "(//span[@class='text-xl pr-1 font-semibold'])[3]")
        public static WebElement AttendOffdaysCount;

        @FindBy(xpath = "(//span[@class='text-xl pr-1 font-semibold'])[4]")
        public static WebElement MissPunchCount;
